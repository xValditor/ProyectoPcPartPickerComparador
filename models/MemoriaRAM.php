...
class MemoriaRAM extends Componente {
    ...
    public function __construct($nombre, $fabricante, $precio, $consumo, $anioLanzamiento, $capacidad, $frecuencia, $tipo, $latencia, $id = 0) {
    ...
    public function getLatencia() {
        return $this->latencia;
    }

    public function setLatencia($latencia): self {
        $this->latencia = $latencia;
        return $this;
    }
}