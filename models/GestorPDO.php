        ...
        try {
            if ($componente instanceof Procesador) {
                $sql = "INSERT INTO componentes 
                        (tipoComponente, nombre, fabricante, precio, consumo, anioLanzamiento, nucleos, frecuencia, socket) 
                        VALUES (:tipo, :nombre, :fabricante, :precio, :consumo, :anio, :nucleos, :frecuencia, :socket)";
                $stmt = $this->db->prepare($sql);
                ...
                $sql = "INSERT INTO componentes 
                        (tipoComponente, nombre, fabricante, precio, consumo, anioLanzamiento, memoriaVRAM, velocidadMemoria, ensamblador) 
                        VALUES (:tipo, :nombre, :fabricante, :precio, :consumo, :anio, :vram, :velocidad, :ensamblador)";
                $stmt = $this->db->prepare($sql);
                ...
                $sql = "INSERT INTO componentes 
                        (tipoComponente, nombre, fabricante, precio, consumo, anioLanzamiento, capacidad, frecuencia, tipo, latencia) 
                        VALUES (:tipo, :nombre, :fabricante, :precio, :consumo, :anio, :capacidad, :frecuencia, :tipoRam, :latencia)";
                $stmt = $this->db->prepare($sql);
        ...
        try {
            if ($componente instanceof Procesador) {
                $sql = "UPDATE componentes SET 
                        nombre = :nombre, fabricante = :fabricante, precio = :precio, 
                        consumo = :consumo, anioLanzamiento = :anio,
